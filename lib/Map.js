...
var bank1 = new Register( {
  ...
  fromBuffer: function( buf ) {
    ...
    remoteQuality.set( buf.readUInt16BE( 6 ));
    systemState.set( buf.readUInt16BE( 8 ));
    volts.set( buf.readUInt16BE( 10 ));
  },
...
var sensorData = new Register( {
  ...
  fromBuffer: function( buf ) {
    ...
    if( buf.length < 46 ){
      ...
      // 40 byte packet
      this.packet = {
        type: values.shiftUInt8(),
        board: values.shiftUInt16(),
        serial: values.shiftUInt32(),
        faults: values.shiftBytes(16),
        meters: {
          m1: values.shiftUInt8(),
          m2: values.shiftUInt8(),
          m3: values.shiftUInt8(),
          m4: values.shiftUInt8(),
          m5: values.shiftUInt8(),
          m6: values.shiftUInt8(),
          m7: values.shiftUInt8(),
          m8: values.shiftUInt8(),
          m9: values.shiftUInt8(),
          m10: values.shiftUInt8()
